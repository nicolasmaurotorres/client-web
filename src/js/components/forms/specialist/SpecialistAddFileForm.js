...
import { specialistAddFile } from '../../../actions/specialistActions'
import { setSpinnerState } from '../../../actions/spinnerActions';

class SpecialistAddFileForm extends React.Component {
    constructor(props){
        super(props);
...
SpecialistAddFileForm.propTypes = {
...
export default connect(mapStateToProps,mapDispatchToProps)(SpecialistAddFileForm);